...
Para calcular o bloco divides 15/(ninodes_grandes_por_bloco * (n_de_blocos/2)) que vai dar 0,qqlcoisa, truncado dá 0. Ao 0 tens que somar o offset de onde começa a area dos dados. <br>
